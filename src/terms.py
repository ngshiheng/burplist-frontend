...
def terms():
    ...
    The Terms of Service, Burplist itself, and our prices can change at any time. We'll warn you 30 days in advance of any price changes. We'll try to warn you about major changes to the Terms of Service, but we make no guarantees.
    ...
    Your use of the Burplist service is governed by this agreement (the "Terms"). "Burplist" means Burplist Inc. The "Service" means the services Burplist makes available include our web site (https://burplist.me), our blog, our API, and any other software, sites, and services offered by Burplist in connection to any of those. "Customer Source Code" means any source code you submit to Burplist for the purpose of using the Service. "Content" means all content generated by Burplist on your behalf (including metric data) and does not include Customer Source Code.
    ...
    Burplist may make changes to the Terms from time to time. You may reject the changes by terminating Your account. You understand and agree that if You use the Service after the date on which the Terms have changed, Burplist will treat Your use as acceptance of the updated Terms.
    ...
    * You agree that Burplist has no responsibility or liability for the deletion or failure to store any Content and other communications maintained or transmitted through use of the Service. You further acknowledge that You are solely responsible for securing and backing up Customer Source Code.
